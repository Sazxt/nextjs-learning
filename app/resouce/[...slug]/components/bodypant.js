export function Bodypant(){
    return (<>
    <h1 className="mt-3 text-base/loose">Resouce LInk </h1>
    <div className="space-y-6 py-8 text-base leading-7 text-gray-600">
        ...
        <div className="pt-8 text-base font-semibold leading-7 p-10 bg-lime-300 rounded-e-3xl">
